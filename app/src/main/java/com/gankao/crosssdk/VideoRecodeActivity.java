...
//            if (ContextCompat.checkSelfPermission(mActivity,  Manifest.permission.MANAGE_EXTERNAL_STORAGE)
...
//        }
    ...
    private void startRecorder() {
        ...
        File dirFile = createVideoFile();

        mProcessCameraProvider.bindToLifecycle(
                this, CameraSelector.DEFAULT_BACK_CAMERA, mPreview,
                mVideoCapture);

        VideoCapture.OutputFileOptions fileOptions = new VideoCapture.OutputFileOptions.Builder(dirFile).build();
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {

            return;
        }
        mVideoCapture.startRecording(fileOptions, ContextCompat.getMainExecutor(mActivity),
                new VideoCapture.OnVideoSavedCallback() {
                    ...
                    public void onVideoSaved(@NonNull VideoCapture.OutputFileResults outputFileResults) {
                        ...
                        contentValues.put(MediaStore.Video.Media.DISPLAY_NAME, dirFile.getName());
                        contentValues.put(MediaStore.Video.Media.MIME_TYPE, "video/mp4");
                        contentValues.put(MediaStore.Video.Media.RELATIVE_PATH, Environment.DIRECTORY_MOVIES + "/CameraX");
    ...
    private File createVideoFile() {
        ...
        File storageDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES + "/CameraX");
