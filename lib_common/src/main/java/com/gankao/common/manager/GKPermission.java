...
public final class GKPermission {

    private GKPermission() {}
     ...
     * {@link GKPermission#READ_EXTERNAL_STORAGE} 和 {@link GKPermission#WRITE_EXTERNAL_STORAGE} 权限
     *
     ...
     *
     * 1. 如果适配了分区存储的情况下：
     *     1) 如果项目 targetSdkVersion <= 32 需要申请 {@link GKPermission#READ_EXTERNAL_STORAGE}
     *     2) 如果项目 targetSdkVersion >= 33 需要申请 {@link GKPermission#READ_MEDIA_IMAGES}
     *
     * 2. 如果没有适配分区存储的情况下：
     *     1) 如果项目 targetSdkVersion <= 29 需要申请 {@link GKPermission#READ_EXTERNAL_STORAGE}
     *     2) 如果项目 targetSdkVersion >= 30 需要申请 {@link GKPermission#MANAGE_EXTERNAL_STORAGE}
     */
    ...
    public static final class Group {
        ...
        public static final String[] STORAGE = new String[] {
                GKPermission.READ_EXTERNAL_STORAGE,
                GKPermission.WRITE_EXTERNAL_STORAGE};

        /** 日历权限 */
        public static final String[] CALENDAR = new String[] {
                GKPermission.READ_CALENDAR,
                GKPermission.WRITE_CALENDAR};

        /** 联系人权限 */
        public static final String[] CONTACTS = new String[] {
                GKPermission.READ_CONTACTS,
                GKPermission.WRITE_CONTACTS,
                GKPermission.GET_ACCOUNTS};
