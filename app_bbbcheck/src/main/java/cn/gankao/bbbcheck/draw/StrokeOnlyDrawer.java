...
public class StrokeOnlyDrawer {
    ...
    public void drawDot(int index, int force, float x, float y) {
        if (mCanvas == null
                || mBitmap == null
                || mBitmap.isRecycled())
            return;
        switch (index) {
            case 0:
                g_x0 = x;
                g_y0 = y;
                g_p0 = getPenWidth(2, force) * mScale;
                mCanvas.drawCircle(g_x0, g_y0, 0.5F, mPaint);
                break;
            case 1:
                g_x1 = x;
                g_y1 = y;
                g_p1 = getPenWidth(2, force) * mScale;
            ...
            default:
                g_x3 = x;
                g_y3 = y;
                g_p3 = getPenWidth(2, force) * mScale;
